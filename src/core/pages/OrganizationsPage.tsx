...
const columns = [
  ...
  },
  {
    ...
    cell: (row: Organization) => (
      <span className={`px-2 py-1 rounded text-xs ${row.is_active ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300' : 'bg-muted text-muted-foreground'}`}>
