  ...
  return (
    <div className="container mx-auto py-6">
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-hidden flex flex-col p-0 gap-0 bg-white">
          <DialogHeader className="px-6 pt-6 pb-4 border-b border-gray-200 shrink-0 bg-gray-50">
            <DialogTitle className="text-gray-900">Редактировать клиента</DialogTitle>
          </DialogHeader>
