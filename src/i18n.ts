  ...
  en: {
    translation: {
      ...
      branches: {
        ...
        mapHint: 'Click on the map to place a marker, drag it to refine.',
        isActive: 'Active',
        status: 'Status',
        active: 'Active',
        inactive: 'Inactive',
  ...
  ru: {
    translation: {
      ...
      branches: {
        ...
        save: 'Сохранить',
        name: 'Название',
        namePlaceholder: 'Введите название филиала',
        address: 'Адрес',
        addressPlaceholder: 'Введите адрес',
        organization: 'Организация',
        terminalGroup: 'Терминальная группа',
        selectOrganization: 'Выберите организацию',
        selectTerminalGroup: 'Выберите терминальную группу',
        latitude: 'Широта',
        longitude: 'Долгота',
        coordinates: 'Координаты',
        pickOnMap: 'Выберите место на карте',
        mapHint: 'Нажмите на карту, чтобы поставить маркер, перетащите для уточнения.',
        isActive: 'Активен',
        status: 'Статус',
        active: 'Активен',
        inactive: 'Неактивен',
        ...
        createSuccess: 'Филиал успешно создан',
        createError: 'Не удалось создать филиал',
        updateSuccess: 'Филиал успешно обновлен',
        updateError: 'Не удалось обновить филиал',
      ...
      attendance: {
        ...
        noCheckIn: 'Нет прихода',
        noCheckOut: 'Ещё не ушёл',
        checkInPhoto: 'Фото прихода',
        checkOutPhoto: 'Фото ухода',
